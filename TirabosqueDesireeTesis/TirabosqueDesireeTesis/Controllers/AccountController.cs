...
namespace TirabosqueDesireeTesis.Controllers
{
    ...
    public class AccountController : Controller
    {
...

        {
            ...
            if (user != null)
            {
                var usuario = db.Usuarios.Find(user.IdUsuario);
                if (usuario != null)
                {
                    Session["Logo"] = usuario.Imagen;
                }
            }
        }
        ...
        [AllowAnonymous]
        public ActionResult LoginMensaje(string returnUrl)
        {
            ViewBag.ReturnUrl = returnUrl;
            return View();
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> LoginMensaje(LoginViewModel model, string returnUrl)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
